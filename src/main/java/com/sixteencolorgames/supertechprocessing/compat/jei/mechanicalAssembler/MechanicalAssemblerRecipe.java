 ...
 * @author oa10712
 */
public class MechanicalAssemblerRecipe extends BlankRecipeWrapper {
    ...
    public MechanicalAssemblerRecipe(@Nonnull List<RecipeIngredient> input, @Nonnull ItemStack output) {
