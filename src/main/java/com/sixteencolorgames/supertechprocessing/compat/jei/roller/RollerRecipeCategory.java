 ...
 * @author oa10712
 */
public class RollerRecipeCategory extends BlankRecipeCategory {
    ...
    public static void init(IModRegistry registry) {
        ...
        registry.addRecipeCategories(new RollerRecipeCategory(guiHelper));
        registry.addRecipeHandlers(new RollerRecipeHandler());
    ...
    public RollerRecipeCategory(IGuiHelper guiHelper) {
        backgroundLocation = new ResourceLocation(SuperTechProcessingMod.MODID, "textures/gui/rollerElectricGui.png");
        ...
        localizedName = Translator.translateToLocal("gui.jei.category.roller");
    }
