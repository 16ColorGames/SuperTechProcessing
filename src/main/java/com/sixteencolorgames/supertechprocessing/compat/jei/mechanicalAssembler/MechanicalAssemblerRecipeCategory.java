 ...
 * @author oa10712
 */
public class MechanicalAssemblerRecipeCategory extends BlankRecipeCategory<MechanicalAssemblerJEIRecipe> {

    protected static final int inputSlot = 0;
    protected static final int outputSlot = 10;
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, MechanicalAssemblerJEIRecipe recipeWrapper, IIngredients ingredients) {
        IGuiItemStackGroup guiItemStacks = recipeLayout.getItemStacks();

        guiItemStacks.init(0, true, 0, 0);
        guiItemStacks.init(1, true, 0, 18);
        guiItemStacks.init(2, true, 0, 36);
        guiItemStacks.init(3, true, 51, 0);
        guiItemStacks.init(4, true, 69, 0);
        guiItemStacks.init(5, true, 42, 18);
        guiItemStacks.init(6, true, 59, 18);
        guiItemStacks.init(7, true, 78, 17);
        guiItemStacks.init(8, true, 51, 35);
        guiItemStacks.init(9, true, 69, 35);
        guiItemStacks.init(outputSlot, false, 119, 18);

        recipeWrapper.setupStacks(guiItemStacks);
    }
}
