...
public class ContainerElectricExtruder extends ContainerBase {
    ...
    public ContainerElectricExtruder(InventoryPlayer playerInventory, IInventory extrudeInv) {
        super(playerInventory, extrudeInv);
        this.addSlotToContainer(new Slot(extrudeInv, TileEntityElectricExtruder.INPUT_SLOT, 56, 35));
        this.addSlotToContainer(new SlotFurnaceOutput(playerInventory.player, extrudeInv, TileEntityElectricExtruder.OUTPUT_SLOT, 116, 35));
